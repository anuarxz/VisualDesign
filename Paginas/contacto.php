...
<head>
    ...
    <title>VisualDesign - Contacto</title>
  ...
  ?>
      ...
      <?php
          if (isset($_POST['enviar'])) {
            ...
            if (empty($correo) || empty($texto) || empty($nombre) || empty($apellido) || empty($ciudad)){
              echo "<br><h4 class='text-center'>Debes introducir los datos<br><br>";
              echo '<a href="../Paginas/contacto.php"><button type="button" class="btn btn-primary text-center">Volver al formulario</button></a></h4>';
            }else {
              if (!filter_var($correo, FILTER_VALIDATE_EMAIL)) {
                echo "<br><h4 class='text-center'>Formato de correo inválido<br><br>";
                echo '<a href="../Paginas/contacto.php"><button type="button" class="btn btn-primary text-center">Volver al formulario</button></a></h4>';
              }else{
                if (!preg_match("/^[a-zA-ZñÑáéíóúÁÉÍÓÚ0-9\s]{10,}/", $texto)) {
                  echo "<br><h4 class='text-center'>La descripción no está bien escrita<br><br>";
                  echo '<a href="../Paginas/contacto.php"><button type="button" class="btn btn-primary text-center">Volver al formulario</button></a></h4>';
                }else{
          ...
          $sql = "INSERT INTO Contacto(Nombre, Apellido, Correo, Ciudad, Texto) VALUES  
          ('$nombre', '$apellido', '$correo','$ciudad', '$texto');";
      ...
      <div class="container-xl mt-5">
        ...
        <form class="row g-3 mt-1" name="input" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" ENCTYPE="multipart/form-data" onsubmit="return contacto()">
          <div class="col-md-6">
