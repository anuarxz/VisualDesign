...
<head>
    ...
    <title>VisualDesign - Catálogo</title>
...
<body>
    <nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary bg-gradient">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active"  aria-current="page" href="../Paginas/catalogo.php">Catálogo</a>
              </li>
              <li class="nav-item">
            ...
            <form class="d-flex" action="" method="post">
              <input class="form-control me-2" type="text" placeholder="Buscar" name="campo" id="campo">
            </form>
            <div class="d-flex">
            <?php
      ...
      <div class="container px-4 py-5" id="custom-cards">
        <h2 class="pb-2 border-bottom">¿No encuentras lo que buscas?</h2>
          ...
          <div class="col zoom">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('../Imagenes/tarjeta1.png');">
              <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Personalizado</h3>
                <ul class="d-flex list-unstyled mt-auto">
                  <li class="me-auto">
                    50-500€
                  </li>
                  <li class="d-flex align-items-center me-2">
                    <a href="contacto.php"><button type="button" class="btn btn-danger">Comprar</button></a>
                  </li>
      ...
      <div class="container px-4 py-5" id="custom-cards">
        <h2 class="pb-2 border-bottom">Preguntas frecuentes</h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                  ¿Pueden actualizar o rediseñar mi sitio web existente?
                </button>
              </h2>
