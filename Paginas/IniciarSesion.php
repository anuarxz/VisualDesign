        ...
        if (empty($correo) || empty($password))
            ...
            if($resultado = $dwes->query($sql)) {
                ...
                if ($fila != null) {
                    ...
                    if(strcmp($correo, "admin@gmail.com")==0)
                    {
...
<head>
    ...
    <title>VisualDesign - Inicio Sesión</title>
  ...
  <br><br>
    <main class="form-signin w-100 m-auto">
      <form action='<?php echo $_SERVER['PHP_SELF'];?>' method='post'>
        <img class="mb-4" src="../Imagenes/logo2.png" alt="" width="72" height="57">
        ...
        <a href="../Paginas/registro.php">¿No estás registrado? Regístrate ahora</a>
        </div>
