...
if (strcmp($correo, "admin@gmail.com")) {
...
<head>
    ...
    <title>VisualDesign - Administrar</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../Paginas/admin.php">Administrar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="../Paginas/users.php">Usuarios</a>
                    </li>
                </ul>
    ...
    if (!isset($error)) {
        if (isset($_POST['eliminar'])) {
            $sql = 'DELETE FROM Productos WHERE ID=' . $_REQUEST["idborrar"];

            $resultado2 = $dwes->query($sql);
        ...
        if ($resultado) {
            ...
            while ($row != null) {
                ...
                $sql2 = "SELECT ID, Nombre, Foto FROM Productos WHERE Categoria = '$categoria'";
                    ...
                    echo "<div class='col zoom'>
                        <div class='card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg' style='background-image: url(\"$foto\");'>
                            ...
                            <ul class='d-flex list-unstyled mt-auto'>
                                ...
                                <form name='input' action='admin.php' method='post' ENCTYPE='multipart/form-data'>
...
<div class='pt-4 pb-4 d-grid gap-2 d-sm-flex justify-content-sm-center'>
              <a href='../Paginas/añadir.php'><button type='button' class='btn btn-primary btn-lg px-4 gap-3'>Añadir producto</button></a>
            </div>
