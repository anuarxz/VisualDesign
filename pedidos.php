...
<head>
    ...
    <title>VisualDesign - Pedidos</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../Paginas/pedidos.php">Pedidos</a>
              </li>
              <li class="nav-item">
...
session_start();
  ...
  // Y comprobamos que el usuario se haya autentificado
   if (!isset($_SESSION['correo'])) {
    ...
    <h1 class="display-5 fw-bold">Sin pedidos</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Registrate o inicia sesión para ver tus pedidos.</p>
...
if($_SESSION['comprado']==true){
      if (!isset($error)) {
        
        $correo = $_SESSION['correo'];
        $sql = "SELECT NombreProducto FROM Compras WHERE CorreoCliente='$correo'";
        $resultado = $dwes->query($sql);
        if ($resultado != null) {
          $row = $resultado->fetch();
          echo " <div class='container px-4 py-5' id='custom-cards'>
        <h2 class='pb-2 border-bottom'>Productos comprados</h2>
        <div class='row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-3'>";
          while ($row != null) {
            $nombre = $row['NombreProducto'];
            $sql2 = "SELECT ID, Nombre, Foto, Precio FROM Productos WHERE Nombre = '$nombre'";
          ...
          echo '<div class="px-4 py-5 my-5 text-center">
          <img class="d-block mx-auto mb-4" src="../Imagenes/logo2.png" alt="" width="72" height="57">
          <h1 class="display-5 fw-bold">No hay pedidos</h1>
          <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Aún no has realizado ningún pedido</p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
