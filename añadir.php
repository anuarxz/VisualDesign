...
<body >
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="../Paginas/admin.php">Administrar</a>
                    </li>
                    <li class="nav-item">
    ...
    <?php
          ...
          <div class='col-lg-6 mx-auto'>
            <p class='lead mb-4'>Producto agregado correctamente</p>
          </div>
        </div>";
...
<div class="container-md mt-5 pb-5">
        <h2 class="text-center">Datos del nuevo producto</h2>
        <form class="row g-3 mt-1" name="input" action="añadir.php" method="post" ENCTYPE="multipart/form-data" onsubmit="return añadir2()">
        <div class="col-md-6">
