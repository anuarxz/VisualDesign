...
<head>
    ...
    <title>VisualDesign - Usuarios</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../Paginas/users.php">Usuarios</a>
                    </li>
                </ul>
    ...
    if (!isset($error)) {
        if (isset($_POST['eliminar'])) {
            $sql = 'DELETE FROM Clientes WHERE Codigo=' . $_REQUEST["idborrar"];
                ...
                echo "<div class='col pt-2'>
                        <div class='card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg' style='background-image: url();'>
                            ...
                            <ul class='d-flex list-unstyled mt-auto'>
                                <li class='me-auto'>
                                <b>ID:</b> $codigo <b>Nombre:</b> $nombre <b>Apellido:</b> $apellido <b>Correo:</b> $correo <b>Ciudad:</b> $ciudad
                                </li>
                                <li class='d-flex align-items-center me-2'>
                                <form name='input' action='users.php' method='post' ENCTYPE='multipart/form-data'>
                                <input type='hidden' name='idborrar' value='$codigo'>
